...
class ChatsVideoPage extends StatefulWidget {
  final Map friend;
  const ChatsVideoPage({
    super.key,
    required this.friend,
  });
  @override
  State<ChatsVideoPage> createState() => _ChatAudioPageState();
}

class _ChatAudioPageState extends State<ChatsVideoPage> {
  bool isOnCall = false;
  bool isMuted = false;
